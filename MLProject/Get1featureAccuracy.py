...
def Train_Test():
    accuracy_df = pd.DataFrame(columns = ["Feature1","accuracy"])
    ...
    for i in range(0,features_num):
            ...
            accuracy_df = accuracy_df.append({"Feature1":features[i],"accuracy":accuracy},ignore_index=True)
    accuracy_df.to_csv("1featuresAccuracy.csv")
